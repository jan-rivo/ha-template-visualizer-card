      ...
      <ha-card>
        ...
        <div class="card-content">
          ${this.globalError?m`<div class="tpl-empty">
                ...
                ${this.config.showReferences!==!1?m`<ha-expansion-panel
